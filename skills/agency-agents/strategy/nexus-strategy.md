...
| **Handoff** | Structured transfer of work between agents with full context |
| **RICE Scoring** | Reach × Impact × Confidence / Effort prioritization framework |
| **MoSCoW** | Must/Should/Could/Won't feature classification |
| **SCQA** | Situation-Complication-Question-Answer executive summary format |
| **P0/P1/P2/P3** | Critical/High/Medium/Low severity classification |
