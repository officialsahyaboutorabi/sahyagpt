...
**First**: Use the impeccable-design skill for design principles and anti-patterns.
...
5. **Anti-Patterns (CRITICAL)** - Check against ALL the **DON'T** guidelines in the impeccable-design skill. Look for AI slop tells (AI color palette, gradient text, glassmorphism, hero metrics, card grids, generic fonts) and general design anti-patterns (gray on color, nested cards, bounce easing, redundant copy).
...
- **Suggested command**: Which command to use (prefer: available commands — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: available commands. You may also suggest other installed skills you're sure exist, but never invent commands.
